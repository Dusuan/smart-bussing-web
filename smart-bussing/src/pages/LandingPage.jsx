  ...
  return (
    <>
      <div className="h-full scroll-smooth flex flex-col justify-between">
        ...
        <div className="flex justify-center items-start min-h-screen bg-[#EEFEFF] z-10 pt-15 lg:pt-32 pb-20 lg:pb-0">
          <DownloadSection />
        </div>
        <div className="bg-[#EEFEFF] z-10">
          <div className="flex flex-col justify-center items-center mb-40">
            <div id="mobile-register" className="scroll-mt-50 flex flex-col justify-center items-center mb-10 text-center text-[#5F93A2] text-2xl lg:text-5xl">
